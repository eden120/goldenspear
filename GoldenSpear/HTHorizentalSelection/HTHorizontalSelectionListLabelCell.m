...
//		_cornerImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"topbar_stick.png"]];
//		_cornerImage.translatesAutoresizingMaskIntoConstraints = NO;
...
//		[self.contentView addSubview:_cornerImage];
		...
		[self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-5-[_titleLabel]-5-|"
		...
		_titleFontsByState[@(UIControlStateNormal)] = [UIFont systemFontOfSize:15];
