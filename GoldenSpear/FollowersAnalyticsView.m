...
@interface FollowersAnalyticsView ()
...
@implementation FollowersAnalyticsView
...
- (void)commonInit
{
    ...
    NSArray *objects = [[NSBundle mainBundle] loadNibNamed:@"FollowersAnalyticsView"
                                                     owner:self
                                                   options:nil];
