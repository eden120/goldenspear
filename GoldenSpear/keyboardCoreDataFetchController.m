//
//  keyboardCoreDataFetchController.m
//  GoldenSpear
//
...
@interface keyboardCoreDataFetchController () <NSFetchedResultsControllerDelegate>

@property (nonatomic) NSFetchedResultsController *fetchedResultsController;

@property (nonatomic, weak) keyboardCoreDataTableViewController *tableViewController;
@property (nonatomic, weak) keyboardCoreDataCollectionViewController *collectionViewController;
...
@implementation keyboardCoreDataFetchController
