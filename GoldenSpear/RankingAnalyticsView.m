...
@interface RankingAnalyticsView ()
...
@implementation RankingAnalyticsView
...
- (void)commonInit
{
    ...
    NSArray *objects = [[NSBundle mainBundle] loadNibNamed:@"RankingAnalyticsView"
                                                     owner:self
                                                   options:nil];
